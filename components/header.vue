        ...
        <div class="font-normal font-mono inline-block">
          ...
          <span class="inline-block align-middle">
            <a href="https://www.loyalytics.ai/" target="_blank">
              <img src="~/assets/images/loyalytics.png" title="loyalytics.ai" alt="loyalytics.ai" width="15"
                height="15">
            </a>
          </span>
        </div>
        ...
        <div class="flex gap-1 items-center justify-end">
          <span class="p-0.5 rounded-md ">
            <a href="https://github.com/ajaykrupalk" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="22" viewBox="0,0,256,256"
                class="fill-white hover:fill-gray-300/75">
          ...
          <span class="p-0.5 rounded-md ">
            <a href="https://www.linkedin.com/in/ajaykrupalk" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="18px"
                class="fill-white hover:fill-gray-300/75" height="18px">
                <path
          ...
          <span class="p-1 rounded-md ">
            <a href="https://dev.to/ajaykrupalk" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-white hover:fill-gray-300/75"
                aria-label="dev.to" role="img" viewBox="0 0 512 512">
