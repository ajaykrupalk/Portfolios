    ...
    <div class="flex flex-col gap-6 mx-auto p-10 md:w-[40em]">
        ...
        <div class="text-sm flex flex-col space-y-2" v-for="blog in data" :key="blog">
            <NuxtLink :to="`/blog/${blog.slug}`">
                <h4
                    class="text-base font-medium font-mono underline underline-offset-4 decoration-1 font-mono hover:text-gray-300/75">
                    {{ blog.title }}
                </h4>
            </NuxtLink>
...
const { data } = await useFetch(`${config.public.BACKEND_URI}/blogs`);
